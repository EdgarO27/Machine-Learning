...
for ds in dataSets:
    ...
    #this dictionary will allow us to desginate a number to each category if a key is found per 
    ...
    for i in range (10):
       ...
       #--> add your Python code here
        ...
        with open(test, 'r') as csvfile:
            readerTest = csv.reader(csvfile)
            for i, row in enumerate(readerTest):
                if i > 0: #skipping the header
                    dbTest.append (row)
        print(dbTest)
        # for data inappend dbTest:
